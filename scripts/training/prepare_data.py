...
if __name__ == "__main__":
    training_pairs = create_translation_pairs("/Users/karanvirkhanna/BigCodeNet/training_meta.csv")
    training_data = prepare_data(training_pairs)

    with open("/Users/karanvirkhanna/BigCodeNet/model/training_data.json", "w") as f:
